...
//			"<br/><u>COLMAP reformatting rules for tables</u>",
//			"( file1 ) : ",
//			"   { table1 : ( tablename ),",
...
//			"( file2 ) : {}");
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if (!config.isEmpty()) {
			...
			info.put("FORM", DABFormatter.formatForm("DAB Configuration",config,null));
		}
		else {
			configform = DABFormatter.formatForm("DAB Configuration (saved)",ccomp.getConfig(),ccomp.getConfigDescriptions());
		}
